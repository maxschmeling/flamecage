...
{
  public static class PasswordBoxAttachments
  {
    public static readonly DependencyProperty BoundPassword =
        DependencyProperty.RegisterAttached("BoundPassword", typeof(string), typeof(PasswordBoxAttachments), new PropertyMetadata(string.Empty, OnBoundPasswordChanged));
