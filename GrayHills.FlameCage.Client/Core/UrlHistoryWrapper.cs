...
namespace GrayHills.FlameCage.Client.Core
{
	...
	public class UrlHistoryWrapperClass
	{
		...
		Win32api.SortFileTimeAscendingHelper.UrlHistoryClass urlHistory;
		Win32api.SortFileTimeAscendingHelper.IUrlHistoryStg2 obj;
		...
		public UrlHistoryWrapperClass()
		{
			...
			urlHistory = new Win32api.SortFileTimeAscendingHelper.UrlHistoryClass();
			obj = (Win32api.SortFileTimeAscendingHelper.IUrlHistoryStg2) urlHistory;
		...
		{
			return new STATURLEnumerator((Win32api.SortFileTimeAscendingHelper.IEnumSTATURL)obj.EnumUrls);
		}
		...
		{
			Win32api.SortFileTimeAscendingHelper.IEnumSTATURL enumrator;
			int index;
			Win32api.SortFileTimeAscendingHelper.STATURL staturl;
			...
			{
				staturl = new Win32api.SortFileTimeAscendingHelper.STATURL();
			...
			/// </summary>
			public Win32api.SortFileTimeAscendingHelper.STATURL Current
			{
				get
				{
					return staturl;
			...
			{
				Win32api.SortFileTimeAscendingHelper.IEnumSTATURL ppenum;
