...
[assembly: WebActivator.PreApplicationStartMethod(typeof(GrayHills.FlameCage.Client.App_Start.SQLCEEntityFramework), "Start")]

namespace GrayHills.FlameCage.Client.App_Start {
    public static class SQLCEEntityFramework {
        public static void Start() {
            ...
            DbDatabase.SetInitializer(new CreateCeDatabaseIfNotExists<EfCfRepository>());
        }
    }
